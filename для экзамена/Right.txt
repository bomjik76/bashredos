...
IP="10.10.10.1/25"    # задать ip интерфейсу
...
NETWORK_BRANCH="11.11.11.0/27"
NETWORK_HQ="10.10.10.0/25"
...
setenforce 0
sed -i '20 a $PORT' /etc/ssh/sshd_config
...
sed -i '23 a MaxAuthTries 3' /etc/ssh/sshd_config
